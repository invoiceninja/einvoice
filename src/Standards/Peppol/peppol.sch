  ...
  <pattern>
    ...
    <rule context="cac:PaymentMeans[$supplierCountryIsNL]">
      ...
      <assert id="NL-R-008"
        ...
        flag="fatal">[NL-R-008] For suppliers in the Netherlands, the payment means code
        (cac:PaymentMeans/cbc:PaymentMeansCode) MUST be one of 30, 48, 49, 57, 58 or 59</assert>
    </rule>
