...
"([!#-'*+\/-9=?A-Z^-~-]+(\\.[!#-'*+\/-9=?A-Z^-~-]+)*|\"(\\[\\]!#-[^-~ \\t]|(\\\\[\\t -~]))+\")@([!#-'*+\/-9=?A-Z^-~-]+(\\.[!#-'*+\/-9=?A-Z^-~-]+)*|\\[[\\t -Z^-~]*\\])" => '/([!#-\'*+\/-9=?A-Z^-~-]+(\.[!#-\'*+\/-9=?A-Z^-~-]+)*|"([\]!#-[^-~ \t]|(\\[\t -~]))+")@([!#-\'*+\/-9=?A-Z^-~-]+(\.[!#-\'*+\/-9=?A-Z^-~-]+)*|\[[\t -Z^-~]*\])/u',
'[A-Z]{2}' => '/[A-Z]{2}/',
'(\\p{IsBasicLatin}{5,12})' => '/[\x{0020}-\x{007E}]{5,12}/u',
'.+@.+[.]+.+' => '/.+@.+\..+/',
'[A-Z]{3}' => '/[A-Z]{3}/',
'(\\p{IsBasicLatin}{1,20})' => '/[\x{0020}-\x{007E}]{1,20}/u',
'[\\-]?[0-9]{1,11}\\.[0-9]{2}' => '/[\-]?[0-9]{1,11}\.[0-9]{2}/',
'[\\-]?[0-9]{1,11}\\.[0-9]{2,8}' => '/[\-]?[0-9]{1,11}\.[0-9]{2,8}/',
'[\p{IsBasicLatin}\p{IsLatin-1Supplement}]{1,200}' => '/[\x{00C0}-\x{00D6}\x{00D8}-\x{00F6}\x{00F8}-\x{00FF}\x{0100}-\x{017F}\x{0180}-\x{024F}]{1,200}/u',
'[0-9]{1,3}\\.[0-9]{2}' => '/[0-9]{1,3}\.[0-9]{2}/',
'[\p{IsBasicLatin}\p{IsLatin-1Supplement}]{1,100}' => '/[\x{0000}-\x{00FF}]{1,100}/u',
'(\\p{IsBasicLatin}{1,15})' => '/[\x{0020}-\x{007E}]{1,15}/u',
'[\p{IsBasicLatin}\p{IsLatin-1Supplement}]{1,80}' => '/[\x{0000}-\x{00FF}]{1,80}/u',
'[\p{IsBasicLatin}\p{IsLatin-1Supplement}]{1,1000}' => '/[\x{0000}-\x{00FF}]{1,1000}/u',
'(\\p{IsBasicLatin}{1,8})' => '/[\x{0020}-\x{007E}]{1,8}/u',
'[0-9][0-9][0-9][0-9][0-9]' => '/[0-9]{5}/',
'[A-Z0-9]{11,16}' => '/[A-Z0-9]{11,16}/',
'(\\p{IsBasicLatin}{1,60})' => '/[\x{0020}-\x{007E}]{1,60}/u',
'(\\p{IsBasicLatin}{2,10})' => '/[\x{0020}-\x{007E}]{2,10}/u',
...
'[\p{IsBasicLatin}\p{IsLatin-1Supplement}]{1,60}' => '/[\x{0000}-\x{00FF}]{1,60}/u',
'(\\p{IsBasicLatin}{1,60})' => '/[\x{0020}-\x{007E}]{1,60}/u',
'(\\p{IsBasicLatin}{2,10})' => '/[\x{0020}-\x{007E}]{2,10}/u',
'[A-Z]{2}' => '/[A-Z]{2}/',
'(\\p{IsBasicLatin}{1,20})' => '/[\x{0020}-\x{007E}]{1,20}/u',
...
'(\\p{IsBasicLatin}{5,12})' => '/[\x{0020}-\x{007E}]{5,12}/u',
'(\\p{IsBasicLatin}{1,15})' => '/[\x{0020}-\x{007E}]{1,15}/u',
'[\\p{IsBasicLatin}\\p{IsLatin-1Supplement}]{1,200}' => '/[\p{L}]{1,200}/u',    
'[A-Z0-9]{16}' => '/[A-Z0-9]{16}/',
'[0-9]{1,4}\.[0-9]{1,2}' => '/[0-9]{1,4}\.[0-9]{1,2}/',
'(\\p{IsBasicLatin}{1,35})' => '/[\x{0020}-\x{007E}]{1,35}/u',
